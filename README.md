...
![Intended Runtime Environment: Node.js](https://persian-badge.iran.liara.run/api/badge/NodeJS-43853D?style=flat&logo=nodedotjs&logoColor=white&scale=2)
![NPM Version](https://persian-badge.iran.liara.run/api/npm/v/soroush.js?style=flat&label=SoroushJS&scale=2)
![NPM Version](https://persian-badge.iran.liara.run/api/npm/v/bale.js?style=flat&label=BaleJS&scale=2)
